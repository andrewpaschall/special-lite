...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?> style="background: #fefefe;">
    ...
    <section class="grid-container">
        <div class="grid-x grid-padding-x">
            ...
            <div class="off-canvas position-right" id="mobileContentFilter">
                <?php get_sidebar( 'downloads' ) ?>
            </div>
            ...
            <div class="grid-x"><button type="button" class="button large" data-toggle="mobileContentFilter">Filter Results</button></div>
        </div>
