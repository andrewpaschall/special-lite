								...
								<div style="text-align: center;">
									...
									<div class="_form-content">
										<div class="_form_element _x36227399">
											<label class="_form-label" style="text-align: left; width: 100%;">
												Sign Up for Our Newsletter!<br>
											</label>
											<div class="input-group">
												<input type="text" name="email" placeholder="Type your email"  style="margin-bottom: 0; width: 100%;" required/>
												<span class="input-group-button">
													<button id="_form_5_submit" class="_submit button tiny success" type="submit">
														SIGN UP
													</button>
												</span>
											</div>
