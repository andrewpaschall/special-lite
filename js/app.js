...
jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).ready(function () {
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.product-slider').slick({
    ...
    arrows: false,
    fade: true,
    asNavFor: '.product-slider-control'
  });
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.product-slider-control').slick({
    slidesToShow: 3,
    slidesToScroll: 1,
...
module.exports = __webpack_require__(/*! /Users/andrewpaschall/special-lite/src/assets/js/app.js */"./src/assets/js/app.js");
