...
/**
 * Rep Locator Additions
 */
require get_template_directory() . '/inc/rep-locator.php';
...
function wpb_widgets_init() {
	...
	//Rep Locator Sidebar
	register_sidebar( array(
		'name' =>__( 'Rep Locator Sidebar', 'wpb'),
		'id' => 'sidebar-4',
		'descriptions=' =>__( 'Appears on the static front page template', 'wpb'),
		'before_widget' => '<aside id="%1$s" class="widget %2$s rep-locator">',
		'after_widget' => '</aside>',
		'before_title' => '<h4 class="widget-title">',
        'after_title' => '</h4>',
	));
